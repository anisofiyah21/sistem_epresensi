            ...
            <div id="content">
                ...
                <div class="container-fluid">
                     ...
                     <div class="card shadow mb-4 col-lg-6 ml-1 row text-dark">
                            ...
                            <div class="col-lg">
                               <form action="<?= base_url('Admin/proseseditmapel'); ?>" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?= $tb_mapel['id']; ?>">
                                <div class="form-group">
                                    <label for="code" class="col-sm-3 col-form-label">Kode</label>
                                    <div class="col-sm">
                                        <input type="text" class="form-control" id="code" name="code" value="<?= $tb_mapel['kode']; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm">
                                        <input type="text" class="form-control" id="name" name="name" value="<?= $tb_mapel['nama_mapel']; ?>">
