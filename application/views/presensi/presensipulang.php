<!-- Content Wrapper -->
        ...
        <div class="row mt-5">
            <div class="col-lg">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mt-0 header-title mb-4 text-gray-800">Sudah Presensi</h4>
        ...
        <div class="row mt-3">
            <div class="col-lg">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mt-0 header-title mb-4 text-gray-800">Belum Presensi</h4>
                        <div class="friends-suggestions">
...
<script>
    setInterval(() => {
        $.ajax({
            type: "POST",
            data: {
                content: "<?= decrypt_url($this->uri->segment(3)); ?>"
            },
            url: "<?= base_url('Presensi/sudah_absen_keluar') ?>",
            async: !0,
            success: function(e) {
                $("#sudah-absen_keluar").html(e)
            }
        })
    }, 1e3), setInterval(() => {
        $.ajax({
            ...
            url: "<?= base_url('Presensi/belum_absen_keluar') ?>",
            async: !0,
            success: function(e) {
                $("#belum-absen_keluar").html(e)
            }
        })
    }, 1e3);
</script>